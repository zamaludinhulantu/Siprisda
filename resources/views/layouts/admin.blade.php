...
<body class="bg-gray-100 flex">
    ...
    <aside class="w-64 bg-gray-800 text-white min-h-screen">
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="{{ route('researches.index') }}" class="block py-2 px-3 rounded hover:bg-gray-700">
                <i class="fas fa-book mr-2"></i> Data Penelitian
            </a>
            <a href="{{ route('researches.create') }}" class="block py-2 px-3 rounded hover:bg-gray-700">
                <i class="fas fa-upload mr-2"></i> Unggah Penelitian
            </a>
            <a href="{{ route('reports.statistics') }}" class="block py-2 px-3 rounded hover:bg-gray-700">
                <i class="fas fa-chart-bar mr-2"></i> Statistik
            </a>
            <a href="{{ route('profile.edit') }}" class="block py-2 px-3 rounded hover:bg-gray-700">
